...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Not used, default profile_img is set in DB
    ...
    if (empty($errors)) {
        ...
        $stmt = $conn->prepare("INSERT INTO users (name, email, password, phone, gender, profile_img) VALUES (?, ?, ?, ?, ?, ?)");
        if ($stmt) {
            $stmt->bind_param("ssssss", $name, $email, $hashed_password, $phone, $gender, $profile_img);
            if ($stmt->execute()) {
...
<head>
    <meta charset="UTF-8">
    <title>Sign Up - SmartLearner</title>
    ...
    <div class="container" id="container">
        <div class="form-container sign-in-container">
            <form action="register.php" method="POST">
                <h1>Create SmartLearner Account</h1>
        ...
        <div class="overlay-container">
            <div class="overlay">
                <div class="overlay-panel overlay-right">
                    ...
                    <p>Sign in to join your classes and start learning together!</p>
